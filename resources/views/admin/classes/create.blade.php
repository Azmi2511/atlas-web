        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-2xl shadow-lg border border-blue-100 overflow-hidden">
                <div class="px-6 py-5 bg-blue-50 border-b border-blue-100">
                    ...
                    <p class="text-blue-600 text-sm mt-1">Isi data kelas dengan lengkap</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('classes.store') }}">
                        ...
                        <div class="mb-5">
                            ...
                            <select name="grade" class="w-full rounded-xl border-blue-200 shadow-sm focus:border-blue-400 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition duration-200">
                                ...
                                <option value="10" {{ old('grade') == '10' ? 'selected' : '' }}>10 (Kelas X)</option>
                                <option value="11" {{ old('grade') == '11' ? 'selected' : '' }}>11 (Kelas XI)</option>
                                <option value="12" {{ old('grade') == '12' ? 'selected' : '' }}>12 (Kelas XII)</option>
                            </select>
